      ...
      <div className="responsive-sidebar-container">
        ...
        <div className="responsive-main-content">
          <div className="container" style={{ maxWidth: '1000px', margin: '0' }}>
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.5rem, 4vw, 2rem)', color: 'var(--primary)', marginBottom: '8px' }}>
            ...
            <div className="grid-4" style={{ marginBottom: '40px' }}>
              {[
                ...
                <div key={stat.label} className="card" style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '16px' }}>
                  <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'rgba(212,175,55,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', flexShrink: 0 }}>
                    {stat.icon}
                  </div>
                  <div>
            ...
            <div className="grid-2">
              ...
              <div className="card" style={{ padding: '28px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                  <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.2rem', color: 'var(--primary)' }}>Recent Saved Properties</h2>
                  <Link href="/wishlist" style={{ color: 'var(--secondary)', fontSize: '0.85rem', fontWeight: '600' }}>View All →</Link>
                </div>
                <div style={{ padding: '32px 16px', textAlign: 'center', background: '#F9FAFB', borderRadius: '12px', border: '1px dashed #E5E7EB' }}>
                  <div style={{ fontSize: '2.5rem', marginBottom: '12px', opacity: 0.5 }}>🏘️</div>
                  <h3 style={{ color: 'var(--text)', fontSize: '1.05rem', marginBottom: '8px' }}>No properties saved yet</h3>
                  <p style={{ color: 'var(--text-light)', fontSize: '0.85rem', marginBottom: '16px' }}>Start exploring and save your favorite properties to view them here.</p>
              ...
              <div className="card" style={{ padding: '28px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                  <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.2rem', color: 'var(--primary)' }}>Recent Inquiries</h2>
                  <Link href="/dashboard/inquiries" style={{ color: 'var(--secondary)', fontSize: '0.85rem', fontWeight: '600' }}>View All →</Link>
                </div>
                <div style={{ padding: '32px 16px', textAlign: 'center', background: '#F9FAFB', borderRadius: '12px', border: '1px dashed #E5E7EB' }}>
                  <div style={{ fontSize: '2.5rem', marginBottom: '12px', opacity: 0.5 }}>📨</div>
                  <h3 style={{ color: 'var(--text)', fontSize: '1.05rem', marginBottom: '8px' }}>No active inquiries</h3>
                  <p style={{ color: 'var(--text-light)', fontSize: '0.85rem', marginBottom: '16px' }}>When you inquire about a property, you can track the status here.</p>
