      ...
      <div className="responsive-sidebar-container">
        ...
        <div className="responsive-main-content">
          <div className="container" style={{ maxWidth: '900px', margin: '0' }}>
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.5rem, 4vw, 2rem)', color: 'var(--primary)', marginBottom: '8px' }}>My Inquiries</h1>
            <p style={{ color: 'var(--text-light)', marginBottom: '32px' }}>Track the status of your property inquiries.</p>

            {/* Empty State */}
            <div className="card" style={{ padding: '60px 24px', textAlign: 'center', border: '1px dashed #E5E7EB', background: 'transparent', boxShadow: 'none' }}>
