      ...
      <div style={{ flex: 1, padding: '40px' }}>
        <div className="container" style={{ maxWidth: '1200px', margin: '0' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
            <div>
              <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '2rem', color: 'var(--primary)', marginBottom: '8px' }}>Manage Properties</h1>
                  ...
                  <tr key={prop.id} style={{ borderBottom: '1px solid #E5E7EB' }}>
                    <td style={{ padding: '16px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <img src={prop.images[0]} alt={prop.title} style={{ width: '48px', height: '48px', borderRadius: '8px', objectFit: 'cover' }} />
                        <div>
            ...
            <form onSubmit={handleSaveEdit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <div>
                  ...
                  <select className="form-input" value={editingProp.verified ? 'active' : 'draft'} onChange={e => setEditingProp({ ...editingProp, verified: e.target.value === 'active' })}>
